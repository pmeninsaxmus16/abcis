...
class DefaultController extends Controller
{
    ...
    public function articulosAction()
    {
        ...
        return $this->render('BookingBundle:Default:articulos.html.twig', array('articulos' => $articulos));
    }
    ...
    public function articuloAction($id)
{
    ...
    return $this->render('BookingBundle:Default:articulo.html.twig', array('articulo' => $articuloSeleccionado));
 }
}
