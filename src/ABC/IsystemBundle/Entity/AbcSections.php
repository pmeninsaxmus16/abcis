...
class AbcSections
{
     ...
     * @return AbcSections
     */
    public function addGrade(\ABC\IsystemBundle\Entity\AbcGrade $grade)
    {
        $this->grade[] = $grade;
     ...
     * @param \ABC\IsystemBundle\Entity\AbcGrade $grade
     */
    public function removeGrade(\ABC\IsystemBundle\Entity\AbcGrade $grade)
    {
     ...
     * @return AbcSections
     */
    public function addPosition(\ABC\IsystemBundle\Entity\AbcPosition $position)
    {
     ...
     * @param \ABC\IsystemBundle\Entity\AbcPosition $position
     */
    public function removePosition(\ABC\IsystemBundle\Entity\AbcPosition $position)
    {
