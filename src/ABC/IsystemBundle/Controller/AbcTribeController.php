...
class AbcTribeController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('isystem_admin_mtto_tribe', array('id' => $entity->getId())));
        }
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('isystem_admin_mtto_tribe', array('id' => $id)));
        }
