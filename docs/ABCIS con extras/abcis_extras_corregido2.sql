...
-- -----------------------------------------------------
-- Table `iabcis`.`extra_session`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `iabcis`.`extra_session` (
  `id` INT NOT NULL ,
  ...
  `active` ENUM('f','t') NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_extra_session__abc_sections_idx` (`id_section` ASC) ,
  CONSTRAINT `fk_extra_session__abc_sections`
...
-- -----------------------------------------------------
-- Table `iabcis`.`extra_subsession`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `iabcis`.`extra_subsession` (
  `id` INT NOT NULL ,
  ...
  `created` DATETIME NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_extra_subsession__extra_session_idx` (`id_session` ASC) ,
  CONSTRAINT `fk_extra-subsession_extra-session`
    FOREIGN KEY (`id_session` )
    REFERENCES `iabcis`.`extra_session` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `iabcis`.`extra_course`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `iabcis`.`extra_course` (
  `id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `iabcis`.`extra_course_subsession`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `iabcis`.`extra_course_subsession` (
  `id` INT NOT NULL ,
  `id_course` INT NOT NULL ,
  `id_subsession` INT NOT NULL ,
  `max_members` INT NOT NULL ,
  `active` ENUM('f','t') NOT NULL ,
  INDEX `fk_extra-course-subsession_extra-subsession_idx` (`id_subsession` ASC) ,
  INDEX `fk_extra-course-subsession_extra-course_idx` (`id_course` ASC) ,
  PRIMARY KEY (`id`) ,
  CONSTRAINT `fk_extra-course-subsession_extra-subsession`
    FOREIGN KEY (`id_subsession` )
    REFERENCES `iabcis`.`extra_subsession` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_extra-course-subsession_extra-course`
    FOREIGN KEY (`id_course` )
    REFERENCES `iabcis`.`extra_course` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `iabcis`.`extra_day`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `iabcis`.`extra_day` (
  `id` INT NOT NULL ,
  `day_es` VARCHAR(10) NOT NULL ,
  `day_en` VARCHAR(10) NOT NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `iabcis`.`extra_course_subsession_day`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `iabcis`.`extra_course_subsession_day` (
  `id_day` INT NOT NULL ,
  `id_course_subsession` INT NOT NULL ,
  PRIMARY KEY (`id_day`, `id_course_subsession`) ,
  INDEX `fk_extra-course-subsession-day_extra-day_idx` (`id_day` ASC) ,
  INDEX `fk_extra-course-subsession-day_extra-course-subsession_idx` (`id_course_subsession` ASC) ,
  CONSTRAINT `fk_extra-course-subsession-day_extra-day`
    FOREIGN KEY (`id_day` )
    REFERENCES `iabcis`.`extra_day` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_extra-course-subsession-day_extra-course-subsession`
    FOREIGN KEY (`id_course_subsession` )
    REFERENCES `iabcis`.`extra_course_subsession` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `iabcis`.`extra_course_subsession_grade`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `iabcis`.`extra_course_subsession_grade` (
  `id_course_subsession` INT NOT NULL ,
  `id_grade` INT NOT NULL ,
  PRIMARY KEY (`id_course_subsession`, `id_grade`) ,
  INDEX `fk_extra-course-subsession-grade_abc-grade_idx` (`id_grade` ASC) ,
  INDEX `fk_extra-course-subsession-grade_extra-course-subsession_idx` (`id_course_subsession` ASC) ,
  CONSTRAINT `fk_extra-course-subsession-grade_abc-grade`
    FOREIGN KEY (`id_grade` )
    REFERENCES `iabcis`.`abc_grade` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_extra-course-subsession-grade_extra-course-subsession`
    FOREIGN KEY (`id_course_subsession` )
    REFERENCES `iabcis`.`extra_course_subsession` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `iabcis`.`extra_course_subsession_student`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `iabcis`.`extra_course_subsession_student` (
  `id_card` VARCHAR(10) NOT NULL ,
  `id_course_subsesion` INT NOT NULL ,
  `enrollment_date` DATETIME NOT NULL ,
  `id_card_enroll` VARCHAR(10) NOT NULL ,
  PRIMARY KEY (`id_card`, `id_course_subsesion`) ,
  INDEX `fk_extra-course-subsession-student_abc-student_idx1` (`id_card` ASC) ,
  INDEX `fk_extra_course_subsession_student_extra_subsession_idx` (`id_course_subsesion` ASC) ,
  CONSTRAINT `fk_extra-course-subsession-student_abc-student`
    FOREIGN KEY (`id_card` )
    REFERENCES `iabcis`.`abc_students` (`id_card` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_extra_course_subsession_student_extra_subsession`
    FOREIGN KEY (`id_course_subsesion` )
    REFERENCES `iabcis`.`extra_course_subsession` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
